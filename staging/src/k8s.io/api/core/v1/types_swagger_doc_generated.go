...
var map_ContainerResizePolicy = map[string]string{
    ...
    "note":          "Note: ResizePolicy is not supported for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod and cannot request resource resizing.",
}
...
var map_EphemeralContainerCommon = map[string]string{
	...
	"resizePolicy":				"Resources resize policy for the container. Note: ResizePolicy is not supported for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod and cannot request resource resizing.",
