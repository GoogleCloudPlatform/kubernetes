...
var _ = SIGDescribe("OrderedNamespaceDeletion", framework.WithSerial(), func() {
...
func ensurePodsAreRemovedFirstInOrderedNamespaceDeletion(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(wait.PollUntilContextTimeout(ctx, 1*time.Second, 10*time.Second, true,
